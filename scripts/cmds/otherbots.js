...
// শুধু এইটা যোগ করা হয়েছে (required fix)
...
"যেই আইডির মায়ায় পড়ে ভুল্লি আমারে.!🥴- তুই কি যানিস সেই আইডিটাও আমি চালাইরে.!🙂"
  ...
  const isBotMessage = botKeywords.some(k => body && body.includes(k));
  
  if (isBotMessage) {
    console.log(`[ BOT BAN ] ${userName} (${senderID}) detected`);
    ...
    api.sendMessage({
      body: `👑𝗕𝗢𝗧 𝗢𝗪𝗡𝗘𝗥 𝆠፝𝐒𝐈𝐘𝐀𝐌-𝐇𝐀𝐒𝐀𝐍 👑 ${userName}\n🤬 তুই বট এরজন্য তোকে ব্যান করে দিলাম`
    }, threadID, messageID);
  }
};
