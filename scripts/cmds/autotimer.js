...
module.exports.config = {
  ...
  role: 0,
  author: "ꜰᴀʀʜᴀɴ-ᴋʜᴀɴ",
  description: "⏰ ২৪ ঘণ্টায় ২৪টি নির্দিষ্ট ভিডিও ও টেক্সট পাঠাবে (সব গ্রুপে মেনশন ও সেফ ডিলেসহ ফিক্সড)",
  category: "AutoTime",
  countDown: 3,
};
...
╰───────────────⭓`;
      ...
      // রিসেন্ট ইনবক্সের ৫০টি থ্রেড থেকে গ্রুপ ফিল্টার করবে
      ...
      // সিরিয়াল লুপ + ৫ সেকেন্ড সেফ ডিলে (যাতে সব গ্রুপে যায় ও আইডি ব্যান না হয়)
      for (const thread of groups) {
        ...
        await sleep(5000); // প্রতি গ্রুপের মাঝে ৫ সেকেন্ড বিরতি
      }
...
╰───────────────⭓`;
        ...
        // সিরিয়াল লুপ + অল মেম্বার মেনশন জেনারেটর
        for (const thread of groups) {
          // গ্রুপ মেম্বারদের আইডি থেকে নিখুঁত মেনশন ট্যাগ তৈরি
          ...
          await sleep(5000); // আইডি সুরক্ষিত রাখতে ৫ সেকেন্ড গ্যাপ
        }
  ...
  setInterval(checkTimeAndSend, 60000); // প্রতি ১ মিনিটে ১ বার ব্যাকগ্রাউন্ড চেক
};
